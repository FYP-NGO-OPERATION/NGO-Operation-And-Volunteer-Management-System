...
<execution_context>
@E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/workflows/docs-update.md
</execution_context>
...
<process>
Execute the docs-update workflow from @E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/workflows/docs-update.md end-to-end.

...
```markdown
Read E:/Fyp/ngo_volunteer_app/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read E:/Fyp/ngo_volunteer_app/.claude/agents/gsd-ui-checker.md for instructions.

...
<required_reading>
@E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/references/domain-probes.md
@E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/references/gate-prompts.md
@E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/references/universal-anti-patterns.md
</required_reading>
...
- Read and execute @E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/workflows/discuss-phase-power.md end-to-end
...
```bash
PROFILE_CONTENT=$(cat "E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/USER-PROFILE.md" 2>/dev/null || true)
```
...
2. For EACH user-selected gray area, spawn a Task() in parallel:
   ...
   Task(
     prompt="First, read @E:/Fyp/ngo_volunteer_app/.claude/agents/gsd-advisor-researcher.md for your role and instructions.
...
**Full step-by-step instructions:** @E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/workflows/discuss-phase-power.md

...
```
Task(
  prompt="Read E:/Fyp/ngo_volunteer_app/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/templates/SECURITY.md`

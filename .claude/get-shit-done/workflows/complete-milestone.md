...
```bash
node "E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/templates/retrospective.md`.

...
See E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/templates/discovery.md
...
Use E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/templates/discovery.md.

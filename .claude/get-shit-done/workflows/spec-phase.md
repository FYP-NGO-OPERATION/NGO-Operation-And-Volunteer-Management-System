...
```bash
INIT=$(node "E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/templates/spec.md.

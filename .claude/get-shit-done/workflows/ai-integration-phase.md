...
<required_reading>
@E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/references/ai-frameworks.md
@E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read E:/Fyp/ngo_volunteer_app/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read E:/Fyp/ngo_volunteer_app/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read E:/Fyp/ngo_volunteer_app/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read E:/Fyp/ngo_volunteer_app/.claude/agents/gsd-eval-planner.md for instructions.

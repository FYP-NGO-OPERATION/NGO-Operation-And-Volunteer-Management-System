...
Key references:
- @E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/references/ui-brand.md (display patterns)
- @E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/agents/gsd-user-profiler.md (profiler agent definition)
- @E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/USER-PROFILE.md"
...
```bash
cp "E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/USER-PROFILE.md" "E:/Fyp/ngo_volunteer_app/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to E:/Fyp/ngo_volunteer_app/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at E:/Fyp/ngo_volunteer_app/.claude/commands/gsd/dev-preferences.md"
...
Display: "✓ Added profile section to E:/Fyp/ngo_volunteer_app/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="E:/Fyp/ngo_volunteer_app/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   E:/Fyp/ngo_volunteer_app/.claude/commands/gsd/dev-preferences.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        E:/Fyp/ngo_volunteer_app/.claude/CLAUDE.md
```

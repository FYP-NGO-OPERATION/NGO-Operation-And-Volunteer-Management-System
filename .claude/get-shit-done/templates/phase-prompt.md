...
<!-- For checkpoint task examples and patterns, see @E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/references/checkpoints.md -->
...
See `E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.

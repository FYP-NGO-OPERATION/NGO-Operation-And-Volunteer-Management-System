...
<required_reading>
@E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = E:/Fyp/ngo_volunteer_app/.claude
                  → checks E:/Fyp/ngo_volunteer_app/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = E:/Fyp/ngo_volunteer_app/.claude/get-shit-done
                  → writes to E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/hooks/
...
@E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/references/common-bug-patterns.md

...
Use template from `E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/templates/UI-SPEC.md`

...
Reference full template: `E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `E:/Fyp/ngo_volunteer_app/.claude/get-shit-done/templates/state.md`.

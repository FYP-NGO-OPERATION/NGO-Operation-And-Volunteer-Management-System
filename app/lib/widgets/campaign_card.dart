...
class CampaignCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bool hasImage =
        campaign.coverImageUrl != null || campaign.galleryUrls.isNotEmpty;
    final String? displayImageUrl =
        campaign.coverImageUrl ??
        (campaign.galleryUrls.isNotEmpty ? campaign.galleryUrls.first : null);
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            ...
            blurRadius: 12, // Reduced for performance
            spreadRadius: 2,
            offset: const Offset(0, 4), // Adjusted to match smaller blur
          ),
        ],
      ),
      child: Material(
                    ...
                    if (hasImage)
                      CachedNetworkImage(
                        ...
                        placeholder: (context, url) =>
                            Container(color: _typeColor.withValues(alpha: 0.2)),
                        ...
                        gradient: LinearGradient(
                          ...
                          colors: [
                            Colors.black.withValues(
                              alpha: 0.3,
                            ), // Slightly dark at top for badges
                            Colors.transparent,
                            Colors.black.withValues(
                              alpha: 0.8,
...
class _MagicalTypeBadge extends StatelessWidget {
      ...
      child: ClipRRect(
        ...
        child: Stack(
          children: [
            ...
            // Static stars
            Positioned(top: 4, left: 10, child: _buildStaticStar(0.8)),
            Positioned(top: 15, left: 35, child: _buildStaticStar(0.5)),
            Positioned(top: 8, left: 60, child: _buildStaticStar(0.9)),
            // Glass effect
            Positioned.fill(
  ...
  Widget _buildStaticStar(double opacity) {
    return Opacity(
      opacity: opacity,
      child: Container(
        width: 2.5,

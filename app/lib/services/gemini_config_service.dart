...
class GeminiConfigService {
  ...
  static Future<String> getApiKey(String ngoId) async {
    try {
      final doc = await FirebaseFirestore.instance.collection('ngos').doc(ngoId).get();
      ...
      throw Exception('Gemini API Key is not configured. Please ask the Admin to set it in AI Settings.');
    } catch (e) {

                  ...
                  children: [
                    ...
                    Expanded(
                      ...
                      child: Column(
                        ...
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          const Text('Budget Utilization', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14)),
                          const SizedBox(height: 8),
                          _buildLegendItem(AppColors.error, 'Expenses (Used)'),
                          const SizedBox(height: 4),
                          _buildLegendItem(AppColors.success, 'Remaining Budget'),
                        ],
                      ),
                    ),
                  ],

    ...
    return PopScope(
      ...
      child: Scaffold(
        ...
        drawer: Drawer(
          ...
          child: Column(
            children: [
              _AnimatedDrawerHeader(user: user, currentNgo: currentNgo, isDark: Theme.of(context).brightness == Brightness.dark),
              Expanded(
                child: ListView(
...
class _AnimatedDrawerHeader extends StatefulWidget {
  ...
  const _AnimatedDrawerHeader({required this.user, required this.currentNgo, required this.isDark});
